...
public class UserFrame extends JFrame implements ActionListener {
	...
	private JButton optionButton1 = new JButton("Novo Usuário");
	...
	private void setCorpo1() {
		...
		totalAcess.setLocation(270, 140);
		ttotalAcess.setLocation(150, 140);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == optionButton4) {
			...
			int input = JOptionPane.showConfirmDialog(null, 
	                "Sair e Encerrar Programa?", "Confirmação",JOptionPane.YES_NO_OPTION);
			if(input == 0) {
				dispose();
